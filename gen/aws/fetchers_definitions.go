...
var FetchersDefs = []fetchersDef{
	{
		Name: "infra",
		Api:  []string{"ec2", "elbv2", "elb", "rds", "autoscaling", "ecr", "ecs", "applicationautoscaling", "acm", "eks"},
		Fetchers: []fetcher{
			...
			{Api: "eks", ResourceType: cloud.EKSCluster, AWSType: "eks.Cluster", ManualFetcher: true},
		},
	},
	{
		Name:   "access",
