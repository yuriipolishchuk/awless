...
func TestUpgradeMessaging(t *testing.T) {
	...
	tserver := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Write([]byte(`{"URL":"https://github.com/yuriipolishchuk/awless/releases/latest","Version":"1000.0.0"}`))
	}))
	...
	exp := fmt.Sprintf("New version 1000.0.0 available. Checkout the latest features at https://github.com/yuriipolishchuk/awless/blob/master/CHANGELOG.md\nRun `wget -O awless-1000.0.0.tar.gz https://github.com/yuriipolishchuk/awless/releases/download/1000.0.0/awless-%s-%s.tar.gz`\n", runtime.GOOS, runtime.GOARCH)
